...
int fs_rpc_inode_unlink(uint64_t *base, const char *path);
int fs_rpc_inode_unlink_all(uint64_t *base, const char *path);
int fs_rpc_dir_rename(uint64_t *oldbase, const char *oldpath, uint64_t *newbase,
		      const char *newpath);
